	...
	return (
		<div
			className={`text-center p-5 pb-10 h-[80vh]  overflow-y-hidden md:min-h-[100vh] ${
				darkmode ? "bg-[var(--blue-dark)] text-white " : "bg-white"
			}`}
		>
			...
			<button
				className="w-[200px] h-[50px] rounded-md bg-sky-500/80 text-white font-bold py-4 leading-[10px] hover:shadow-lg hover:opacity-90"
